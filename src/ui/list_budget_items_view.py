...
class ListBudgetItemsView:
    ...
    def _initialize(self):
        ...
        for x in range(len(incomes_list)):
            ...
            income_item = ttk.Label(self.scrollable_incomes.frame, text=str(amount)+ "   " + desc).pack(anchor=W)
        ...
        for x in range(len(expenses_list)):
            ...
            expense_item = ttk.Label(self.scrollable_expenses.frame, text=str(amount)+ "   " + desc).pack(anchor=W)
